...
export type SearchModel = ReturnType<typeof legoSeriesSearchFactory>;
...
export const legoSetFilterFactory = (options: { domain?: Domain }) => {
  ...
  const seriesListSearch = legoSeriesSearchFactory({
...
export function legoSeriesSearchFactory<Done, EntityDone>({
  domain,
  mapToOptions,
  mapToMap,
  requestFx,
