...
export const WikiIntroPage = () => {
  ...
  return (
    <div className="w-[1180px] h-[510px] bg-cover bg-center bg-no-repeat bg-wiki-intro bg-amber-300 rounded-[22px] flex flex-col gap-6 justify-center items-center text-white">
