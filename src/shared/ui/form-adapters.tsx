  ...
  return (
    <select
      ...
      className={clsx(
        ...
        {
          '!h-[35px] !w-[160px] !rounded-md !bg-none !border-none text-filterstext dark:!text-darkfilterstext dark:!text-opacity-50 !indent-3 !pr-10 !outline-0 !mb-1 dark:!bg-darkfilters !cursor-pointer':
            variant === 'primary',
        },
        className,
